...
function maxCategory() {
    ...
    var OBP = [0.3284, 0.3304, 0.3858, 0.3639, 0.38, 0.3568, 0.3299, 0.375, 0.3608, 0.3482, 0.3794, 0.3676];
    var R = [37.0, 31.0, 33.0, 50.0, 42.0, 28.0, 40.0, 36.0, 34.0, 32.0, 41.0, 38.0];
    var RBI = [33.0, 21.0, 35.0, 35.0, 46.0, 29.0, 44.0, 34.0, 38.0, 25.0, 40.0, 33.0];
    var SB = [7.0, 7.0, 5.0, 7.0, 7.0, 5.0, 9.0, 7.0, 6.0, 3.0, 10.0, 7.0];
    var ERA = [4.283, 2.777, 2.16, 2.0, 2.395, 3.405, 4.059, 3.515, 2.235, 1.562, 3.477, 2.821];
    var K = [52.0, 77.0, 63.0, 49.0, 50.0, 57.0, 60.0, 51.0, 47.0, 56.0, 56.0, 42.0];
    var S = [2.0, 1.0, 4.0, 3.0, 2.0, 4.0, 2.0, 1.0, 3.0, 4.0, 2.0, 2.0];
    var W = [4.0, 5.0, 4.0, 6.0, 4.0, 3.0, 2.0, 6.0, 3.0, 5.0, 4.0, 3.0];
    var WHIP = [1.4, 1.1143, 0.855, 1.0, 0.9194, 1.2659, 1.2157, 1.1507, 0.8483, 0.8913, 1.2273, 1.2];
    ...
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 4/27/2026</p>';
    return htmlCode;
}
