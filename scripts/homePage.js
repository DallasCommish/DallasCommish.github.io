...
function maxCategory2025() {
    ...
    var HR = [13, 9, 11, 12, 5, 10, 18, 9, 11, 12, 9, 12];
    var OBP = [0.3427, 0.3308, 0.3602, 0.3401, 0.3445, 0.3574, 0.361, 0.392, 0.3484, 0.3235, 0.3222, 0.3636];
    var R = [39, 35, 30, 38, 24, 31, 43, 39, 46, 38, 25, 33];
    var RBI = [38, 33, 33, 43, 26, 37, 41, 36, 39, 35, 25, 35];
    var SB = [8, 10, 8, 10, 9, 7, 7, 9, 7, 7, 7, 6];
    var ERA = [2.869, 1.901, 1.465, 1.862, 3.273, 2.189, 2.678, 2.238, 2.167, 2.877, 2.17, 1.237];
    var K = [46, 43, 58, 34, 52, 48, 49, 68, 56, 41, 49, 70];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 5/5/2025</p>';
    return htmlCode;
}
