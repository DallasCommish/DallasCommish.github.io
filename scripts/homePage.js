...
function maxCategory2025() {
    ...
    var HR = [13, 9, 11, 12, 8, 10, 18, 12, 11, 12, 9, 19];
    var OBP = [0.3427, 0.3308, 0.3671, 0.3401, 0.3445, 0.3574, 0.3937, 0.392, 0.3484, 0.3497, 0.3516, 0.3636];
    var R = [39, 35, 30, 38, 24, 31, 43, 39, 46, 43, 27, 42];
    var RBI = [52, 33, 33, 43, 26, 37, 44, 36, 39, 51, 28, 48];
    var SB = [8, 10, 8, 10, 9, 7, 9, 9, 7, 7, 10, 6];
    var ERA = [2.869, 1.901, 1.465, 1.862, 3.273, 2.189, 2.678, 2.012, 2.167, 2.877, 1.742, 1.237];
    var K = [53, 53, 58, 35, 59, 52, 49, 68, 56, 44, 49, 70];
    var S = [3, 2, 5, 3, 5, 3, 5, 4, 4, 6, 3, 2];
    var W = [7, 5, 5, 4, 4, 4, 4, 5, 4, 5, 6, 6];
    var WHIP = [0.9851, 1.0763, 0.7692, 0.8966, 1.2727, 1.027, 1.0413, 0.9613, 0.8889, 1.0208, 1.0833, 0.8393];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 5/26/2025</p>';
    return htmlCode;
}
