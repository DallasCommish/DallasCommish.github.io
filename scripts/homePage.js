...
function maxCategory2024() {
    ...
    var BA = [0.2632, 0.2614, 0.2765, 0.3043, 0.3214, 0.262, 0.2589, 0.261, 0.2611, 0.2893, 0.2534, 0.2857];
    var HR = [10.0, 9.0, 11.0, 15.0, 7.0, 14.0, 10.0, 9.0, 13.0, 7.0, 18.0, 10.0];
    var R = [40.0, 27.0, 33.0, 42.0, 43.0, 39.0, 47.0, 41.0, 36.0, 32.0, 39.0, 43.0];
    var RBI = [37.0, 33.0, 30.0, 49.0, 38.0, 29.0, 32.0, 45.0, 43.0, 34.0, 38.0, 34.0];
    var SB = [9.0, 7.0, 10.0, 10.0, 8.0, 7.0, 8.0, 8.0, 5.0, 12.0, 7.0, 5.0];
    var ERA = [1.434, 2.143, 2.298, 2.946, 1.488, 1.756, 1.766, 1.993, 1.742, 2.204, 2.059, 1.856];
    var K = [39.0, 74.0, 88.0, 25.0, 67.0, 60.0, 67.0, 50.0, 66.0, 45.0, 48.0, 60.0];
    var S = [2.0, 1.0, 4.0, 3.0, 2.0, 4.0, 3.0, 3.0, 0.0, 3.0, 6.0, 5.0];
    var W = [5.0, 5.0, 4.0, 2.0, 8.0, 4.0, 3.0, 6.0, 6.0, 6.0, 5.0, 9.0];
    var WHIP = [1.0088, 0.9091, 0.9702, 1.2, 0.878, 0.9756, 0.8972, 0.906, 0.8871, 1.0, 0.8898, 0.8812];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 5/13/2024</p>';
    return htmlCode;
}
