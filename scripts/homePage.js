...
function maxCategory2024() {
    ...
    var R = [47.0, 30.0, 36.0, 47.0, 50.0, 39.0, 47.0, 41.0, 36.0, 33.0, 52.0, 43.0];
    ...
    var S = [3.0, 1.0, 4.0, 3.0, 2.0, 4.0, 5.0, 3.0, 1.0, 3.0, 6.0, 6.0];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 7/10/2024</p>';
    return htmlCode;
}
