...
function maxCategory2025() {
    ...
    var HR = [13, 9, 11, 22, 10, 13, 18, 12, 17, 16, 10, 19];
    var OBP = [0.3667, 0.3556, 0.3744, 0.347, 0.3445, 0.381, 0.3937, 0.392, 0.3502, 0.3497, 0.3516, 0.3717];
    var R = [45, 35, 35, 55, 33, 51, 43, 44, 46, 44, 33, 51];
    var RBI = [52, 33, 33, 54, 38, 45, 47, 43, 43, 51, 34, 48];
    var SB = [8, 10, 8, 10, 9, 7, 12, 9, 9, 8, 10, 9];
    var ERA = [1.34, 1.901, 1.465, 1.862, 2.723, 1.517, 2.077, 1.845, 2.167, 2.301, 1.5, 1.237];
    var K = [55, 62, 58, 38, 59, 52, 53, 68, 56, 54, 53, 75];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 7/14/2025</p>';
    return htmlCode;
}
