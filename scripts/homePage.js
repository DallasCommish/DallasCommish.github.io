...
function maxCategory2024() {
    ...
    var R = [47.0, 36.0, 36.0, 47.0, 50.0, 39.0, 47.0, 41.0, 36.0, 33.0, 52.0, 44.0];
    var RBI = [49.0, 33.0, 40.0, 49.0, 38.0, 37.0, 52.0, 45.0, 46.0, 34.0, 46.0, 47.0];
    var SB = [9.0, 9.0, 11.0, 10.0, 12.0, 7.0, 8.0, 8.0, 5.0, 12.0, 10.0, 12.0];
    var ERA = [1.434, 2.143, 2.277, 1.964, 1.488, 1.756, 1.766, 1.524, 1.742, 2.0, 1.339, 1.856];
    var K = [42.0, 80.0, 88.0, 25.0, 67.0, 60.0, 67.0, 54.0, 66.0, 51.0, 59.0, 73.0];
    var S = [3.0, 1.0, 4.0, 3.0, 2.0, 4.0, 6.0, 4.0, 1.0, 3.0, 6.0, 6.0];
    var W = [5.0, 6.0, 5.0, 2.0, 8.0, 4.0, 5.0, 6.0, 7.0, 6.0, 6.0, 9.0];
    var WHIP = [0.8882, 0.9091, 0.8494, 0.9818, 0.878, 0.7632, 0.8972, 0.8348, 0.8871, 0.9444, 0.719, 0.8321];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 7/17/2024</p>';
    return htmlCode;
}
