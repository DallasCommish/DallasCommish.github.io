...
function maxCategory2025() {
    ...
    var HR = [13, 9, 14, 22, 11, 14, 18, 15, 17, 22, 10, 19];
    var OBP = [0.3667, 0.3556, 0.3929, 0.3569, 0.3445, 0.381, 0.3937, 0.392, 0.3502, 0.3497, 0.3516, 0.3717];
    var R = [45, 35, 47, 55, 34, 51, 44, 44, 46, 49, 33, 51];
    var RBI = [52, 33, 41, 54, 38, 50, 47, 43, 48, 59, 34, 48];
    var SB = [8, 10, 8, 11, 9, 10, 12, 9, 9, 8, 10, 9];
    var ERA = [1.34, 1.901, 1.465, 1.862, 2.723, 1.517, 2.077, 1.845, 2.137, 2.301, 1.5, 1.237];
    var K = [55, 62, 76, 38, 59, 61, 57, 68, 61, 61, 54, 75];
    var S = [4, 2, 5, 4, 5, 3, 7, 4, 6, 6, 3, 4];
    var W = [7, 5, 5, 4, 5, 4, 5, 5, 9, 5, 6, 6];
    var WHIP = [0.8936, 1.0536, 0.7692, 0.7778, 1.0084, 0.8351, 0.7615, 0.9375, 0.8889, 0.9375, 0.8333, 0.7129];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 8/25/2025</p>';
    return htmlCode;
}
