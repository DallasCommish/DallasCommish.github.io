...
function maxCategory2024() {
    ...
    var BA = [0.3238, 0.2763, 0.2765, 0.3043, 0.3214, 0.262, 0.2682, 0.261, 0.2611, 0.2893, 0.2565, 0.2857];
    var HR = [18.0, 11.0, 12.0, 15.0, 11.0, 14.0, 16.0, 15.0, 13.0, 8.0, 18.0, 11.0];
    var R = [47.0, 30.0, 36.0, 42.0, 43.0, 39.0, 47.0, 41.0, 36.0, 32.0, 39.0, 43.0];
    var RBI = [49.0, 33.0, 40.0, 49.0, 38.0, 33.0, 36.0, 45.0, 43.0, 34.0, 42.0, 40.0];
    var SB = [9.0, 9.0, 11.0, 10.0, 8.0, 7.0, 8.0, 8.0, 5.0, 12.0, 7.0, 5.0];
    ...
    var W = [5.0, 5.0, 5.0, 2.0, 8.0, 4.0, 4.0, 6.0, 6.0, 6.0, 6.0, 9.0];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 6/10/2024</p>';
    return htmlCode;
}
