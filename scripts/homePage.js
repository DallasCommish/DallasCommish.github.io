...
function maxCategory() {
    ...
    var R = [40.0, 31.0, 34.0, 50.0, 48.0, 31.0, 43.0, 42.0, 41.0, 39.0, 41.0, 38.0];
    ...
    var ERA = [1.667, 2.497, 2.16, 2.0, 2.325, 3.34, 2.7, 1.543, 2.235, 1.562, 1.862, 1.452];
    ...
    var WHIP = [1.0, 1.024, 0.855, 0.8571, 0.9194, 0.95, 0.9231, 0.7391, 0.8483, 0.8913, 0.9517, 0.871];
    ...
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 7/27/2026</p>';
