...
function maxCategory2024() {
    ...
    var R = [47.0, 30.0, 36.0, 47.0, 43.0, 39.0, 47.0, 41.0, 36.0, 32.0, 52.0, 43.0];
    ...
    var K = [42.0, 74.0, 88.0, 25.0, 67.0, 60.0, 67.0, 54.0, 66.0, 51.0, 51.0, 73.0];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 7/1/2024</p>';
    return htmlCode;
}
