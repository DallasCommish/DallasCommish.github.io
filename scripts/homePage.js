...
function maxCategory() {
    ...
    var RBI = [36.0, 21.0, 35.0, 36.0, 46.0, 29.0, 44.0, 34.0, 38.0, 29.0, 40.0, 33.0];
    var SB = [7.0, 8.0, 7.0, 7.0, 9.0, 5.0, 9.0, 7.0, 6.0, 5.0, 10.0, 7.0];
    var ERA = [2.641, 2.777, 2.16, 2.0, 2.395, 3.405, 3.135, 2.725, 2.235, 1.562, 2.25, 1.452];
    var K = [52.0, 77.0, 63.0, 49.0, 53.0, 57.0, 60.0, 51.0, 59.0, 56.0, 56.0, 43.0];
    var S = [3.0, 2.0, 4.0, 3.0, 2.0, 4.0, 3.0, 1.0, 3.0, 4.0, 2.0, 4.0];
    var W = [4.0, 5.0, 4.0, 6.0, 4.0, 4.0, 2.0, 6.0, 5.0, 5.0, 4.0, 3.0];
    var WHIP = [1.0761, 1.1143, 0.855, 0.973, 0.9194, 0.95, 1.2157, 1.0459, 0.8483, 0.8913, 1.125, 0.871];
    ...
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 5/18/2026</p>';
