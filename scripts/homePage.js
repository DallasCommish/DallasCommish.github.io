...
function maxCategory2025() {
    ...
    var HR = [13, 9, 11, 12, 10, 10, 18, 12, 11, 15, 10, 19];
    var OBP = [0.3667, 0.3308, 0.3744, 0.3401, 0.3445, 0.3574, 0.3937, 0.392, 0.3484, 0.3497, 0.3516, 0.3636];
    var R = [45, 35, 35, 40, 33, 31, 43, 39, 46, 43, 27, 42];
    var RBI = [52, 33, 33, 43, 38, 37, 44, 36, 39, 51, 28, 48];
    var SB = [8, 10, 8, 10, 9, 7, 9, 9, 7, 8, 10, 9];
    var ERA = [2.328, 1.901, 1.465, 1.862, 2.723, 2.189, 2.662, 2.012, 2.167, 2.301, 1.742, 1.237];
    var K = [55, 53, 58, 38, 59, 52, 53, 68, 56, 54, 49, 70];
    var S = [3, 2, 5, 4, 5, 3, 5, 4, 6, 6, 3, 2];
    var W = [7, 5, 5, 4, 4, 4, 5, 5, 4, 5, 6, 6];
    var WHIP = [0.9851, 1.0763, 0.7692, 0.8966, 1.0084, 1.027, 1.0413, 0.9375, 0.8889, 0.9375, 1.0833, 0.8163];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 6/9/2025</p>';
    return htmlCode;
}
...
function ALMinors28() {
    ...
    var superScript = [];
    // first round
    pick.push("Glenn", "Jeremy", "Randall", 
              "Chris", "Jordan", "David", 
              "Rich", "Kelly", "Marty", 
              "Jon", "Brent", "Randall");
    superScript.push("0","0","2",
                     "0","0","0",
                     "0","0","0",
                     "0","0","0");
