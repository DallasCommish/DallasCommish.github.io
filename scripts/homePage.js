...
function maxCategory2025() {
    ...
    var OBP = [0.3427, 0.3308, 0.3273, 0.3401, 0.3, 0.3574, 0.343, 0.392, 0.3484, 0.3235, 0.3222, 0.3373];
    var R = [37, 35, 30, 38, 24, 31, 41, 39, 46, 36, 25, 33];
    var RBI = [38, 30, 32, 43, 26, 37, 40, 33, 38, 30, 25, 35];
    var SB = [8, 10, 4, 10, 9, 7, 7, 9, 7, 7, 7, 6];
    var ERA = [2.869, 3.092, 1.465, 1.862, 3.724, 2.189, 2.678, 2.238, 2.167, 2.877, 2.17, 1.237];
    var K = [46, 37, 58, 34, 52, 48, 45, 68, 56, 41, 49, 70];
    var S = [3, 1, 5, 3, 5, 3, 5, 4, 2, 3, 3, 2];
    var W = [7, 3, 5, 4, 4, 4, 4, 5, 4, 5, 6, 4];
    var WHIP = [1.1438, 1.0763, 0.8466, 0.8966, 1.2727, 1.027, 1.0413, 0.9613, 0.8889, 1.1311, 1.0833, 0.8702];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 4/28/2025</p>';
    return htmlCode;
}
