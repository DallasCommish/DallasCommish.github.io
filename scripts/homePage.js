...
function maxCategory() {
    ...
    var R = [41.0, 31.0, 34.0, 50.0, 48.0, 36.0, 43.0, 42.0, 41.0, 39.0, 41.0, 40.0];
    ...
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 8/31/2026</p>';
    ...
    htmlCode += '</section>';
    htmlCode += '<section class="week">';
    htmlCode += '<h2>Week 18</h2>';
    htmlCode += '<div class="week-meta">After adding 18.csv</div>';
    htmlCode += '<p class="no-changes">No league leader changes.</p>';
    htmlCode += '</section>';
    htmlCode += '<section class="week">';
    htmlCode += '<h2>Week 19</h2>';
    htmlCode += '<div class="week-meta">After adding 19.csv</div>';
    htmlCode += '<table>';
    htmlCode += '<thead><tr><th>Category</th><th>Previous Leader</th><th>Current Leader</th></tr></thead>';
    htmlCode += '<tbody>';
    htmlCode += '<tr><td>S</td><td>The Patsy Killjoys at 6</td><td>Jak of Diamonds at 7</td></tr>';
    htmlCode += '</tbody>';
    htmlCode += '</table>';
    htmlCode += '</section>';
    htmlCode += '</section>';
    ...
    htmlCode += '</section>';
    htmlCode += '<section class="week">';
    htmlCode += '<h2>Week 23</h2>';
    htmlCode += '<div class="week-meta">After adding 23.csv</div>';
    htmlCode += '<p class="no-changes">No league leader changes.</p>';
    htmlCode += '</section>';
