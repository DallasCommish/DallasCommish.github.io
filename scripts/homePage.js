...
function maxCategory2024() {
    ...
    var BA = [0.2632, 0.2614, 0.2661, 0.3043, 0.2452, 0.262, 0.2524, 0.2319, 0.2273, 0.2524, 0.2488, 0.2149];
    var HR = [10.0, 8.0, 7.0, 15.0, 7.0, 10.0, 10.0, 9.0, 6.0, 7.0, 9.0, 8.0];
    var R = [40.0, 26.0, 28.0, 41.0, 36.0, 32.0, 29.0, 34.0, 30.0, 32.0, 31.0, 35.0];
    var RBI = [37.0, 32.0, 30.0, 46.0, 38.0, 23.0, 29.0, 45.0, 24.0, 32.0, 31.0, 25.0];
    var SB = [6.0, 7.0, 6.0, 8.0, 6.0, 6.0, 3.0, 4.0, 3.0, 8.0, 6.0, 3.0];
    var ERA = [1.434, 3.337, 2.298, 2.946, 3.128, 1.756, 1.766, 1.993, 5.037, 3.375, 4.211, 2.718];
    var K = [34.0, 50.0, 48.0, 22.0, 57.0, 44.0, 42.0, 50.0, 66.0, 34.0, 38.0, 60.0];
    var S = [2.0, 0.0, 2.0, 3.0, 0.0, 4.0, 3.0, 2.0, 0.0, 1.0, 6.0, 2.0];
    var W = [5.0, 4.0, 3.0, 1.0, 3.0, 4.0, 3.0, 6.0, 2.0, 3.0, 3.0, 9.0];
    var WHIP = [1.0088, 1.2472, 1.2465, 1.2, 0.878, 0.9756, 0.8972, 0.906, 1.5, 1.125, 1.3824, 1.0671];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 4/17/2024</p>';
    return htmlCode;
}
