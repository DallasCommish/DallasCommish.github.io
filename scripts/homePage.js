...
function maxCategory2025() {
    ...
    var HR = [13, 9, 11, 20, 10, 10, 18, 12, 12, 15, 10, 19];
    var OBP = [0.3667, 0.3556, 0.3744, 0.3401, 0.3445, 0.3574, 0.3937, 0.392, 0.3484, 0.3497, 0.3516, 0.3717];
    var R = [45, 35, 35, 40, 33, 31, 43, 41, 46, 44, 33, 51];
    var RBI = [52, 33, 33, 48, 38, 37, 47, 36, 39, 51, 34, 48];
    var SB = [8, 10, 8, 10, 9, 7, 9, 9, 7, 8, 10, 9];
    var ERA = [1.34, 1.901, 1.465, 1.862, 2.723, 1.517, 2.077, 2.012, 2.167, 2.301, 1.5, 1.237];
