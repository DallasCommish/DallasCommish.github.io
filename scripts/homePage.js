...
function maxCategory2025() {
    ...
    var R = [45, 35, 38, 55, 34, 51, 43, 44, 46, 44, 33, 51];
    var RBI = [52, 33, 34, 54, 38, 45, 47, 43, 48, 51, 34, 48];
    var SB = [8, 10, 8, 11, 9, 8, 12, 9, 9, 8, 10, 9];
    var ERA = [1.34, 1.901, 1.465, 1.862, 2.723, 1.517, 2.077, 1.845, 2.137, 2.301, 1.5, 1.237];
    var K = [55, 62, 76, 38, 59, 61, 53, 68, 56, 61, 53, 75];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 8/4/2025</p>';
    return htmlCode;
}
