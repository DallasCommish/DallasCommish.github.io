...
function maxCategory2024() {
    ...
    var BA = [0.2632, 0.2614, 0.2765, 0.3043, 0.2482, 0.262, 0.2589, 0.261, 0.2273, 0.2893, 0.2534, 0.2857];
    var HR = [10.0, 9.0, 11.0, 15.0, 7.0, 14.0, 10.0, 9.0, 12.0, 7.0, 18.0, 8.0];
    var R = [40.0, 26.0, 33.0, 42.0, 36.0, 39.0, 47.0, 41.0, 31.0, 32.0, 39.0, 37.0];
    var RBI = [37.0, 33.0, 30.0, 46.0, 38.0, 29.0, 32.0, 45.0, 43.0, 34.0, 38.0, 31.0];
    ...
    var K = [36.0, 74.0, 88.0, 25.0, 67.0, 44.0, 67.0, 50.0, 66.0, 45.0, 48.0, 60.0];
    var S = [2.0, 1.0, 4.0, 3.0, 2.0, 4.0, 3.0, 3.0, 0.0, 2.0, 6.0, 5.0];
    var W = [5.0, 5.0, 4.0, 2.0, 4.0, 4.0, 3.0, 6.0, 6.0, 6.0, 4.0, 9.0];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 5/6/2024</p>';
    return htmlCode;
}
