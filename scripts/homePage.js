...
function maxCategory2025() {
    ...
    var HR = [13, 9, 14, 22, 10, 14, 18, 15, 17, 22, 10, 19];
    ...
    var K = [55, 62, 76, 38, 59, 61, 53, 68, 61, 61, 54, 75];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 8/18/2025</p>';
    return htmlCode;
}
