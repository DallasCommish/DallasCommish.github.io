...
function maxCategory2025() {
    ...
    var OBP = [0.3667, 0.3556, 0.3929, 0.347, 0.3445, 0.381, 0.3937, 0.392, 0.3502, 0.3497, 0.3516, 0.3717];
    var R = [45, 35, 36, 55, 33, 51, 43, 44, 46, 44, 33, 51];
    ...
    var K = [55, 62, 76, 38, 59, 61, 53, 68, 56, 54, 53, 75];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 7/28/2025</p>';
    return htmlCode;
}
