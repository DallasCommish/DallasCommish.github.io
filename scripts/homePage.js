...
function maxCategory2024() {
    ...
    var BA = [0.2632, 0.2614, 0.2765, 0.3043, 0.2482, 0.262, 0.2589, 0.261, 0.2273, 0.2893, 0.2488, 0.2857];
    var HR = [10.0, 9.0, 11.0, 15.0, 7.0, 14.0, 10.0, 9.0, 12.0, 7.0, 18.0, 8.0];
    var R = [40.0, 26.0, 33.0, 42.0, 36.0, 39.0, 47.0, 41.0, 31.0, 32.0, 39.0, 35.0];
    var RBI = [37.0, 32.0, 30.0, 46.0, 38.0, 29.0, 30.0, 45.0, 43.0, 34.0, 38.0, 26.0];
    var SB = [9.0, 7.0, 10.0, 10.0, 7.0, 7.0, 8.0, 6.0, 3.0, 12.0, 7.0, 5.0];
    var ERA = [1.434, 2.143, 2.298, 2.946, 1.957, 1.756, 1.766, 1.993, 4.213, 2.204, 2.059, 1.856];
    var K = [36.0, 74.0, 88.0, 25.0, 67.0, 44.0, 57.0, 50.0, 66.0, 45.0, 48.0, 60.0];
    var S = [2.0, 0.0, 4.0, 3.0, 2.0, 4.0, 3.0, 3.0, 0.0, 1.0, 6.0, 5.0];
    var W = [5.0, 5.0, 4.0, 2.0, 4.0, 4.0, 3.0, 6.0, 5.0, 3.0, 4.0, 9.0];
    var WHIP = [1.0088, 0.9683, 0.9702, 1.2, 0.878, 0.9756, 0.8972, 0.906, 1.2766, 1.0, 0.8898, 0.8812];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 4/29/2024</p>';
    return htmlCode;
}
