...
function maxCategory2025() {
    ...
    var HR = [11, 9, 8, 11, 4, 9, 12, 9, 11, 9, 6, 10];
    var OBP = [0.3427, 0.3308, 0.3053, 0.3401, 0.3, 0.3176, 0.3333, 0.392, 0.3484, 0.2945, 0.3222, 0.3243];
    var R = [35, 35, 30, 38, 20, 31, 41, 39, 46, 36, 25, 32];
    var RBI = [37, 30, 32, 43, 26, 37, 40, 28, 38, 30, 23, 25];
    var SB = [5, 10, 4, 10, 9, 7, 7, 9, 7, 7, 6, 6];
    var ERA = [2.869, 3.092, 4.475, 2.406, 3.724, 2.189, 2.678, 2.238, 2.167, 2.877, 3.0, 3.347];
    var K = [46, 37, 58, 30, 52, 48, 45, 68, 56, 41, 33, 40];
    var S = [1, 0, 3, 2, 5, 0, 1, 3, 2, 3, 3, 1];
    var W = [7, 1, 2, 4, 2, 4, 4, 5, 3, 5, 2, 2];
    var WHIP = [1.1438, 1.0763, 1.1768, 0.9505, 1.2828, 1.027, 1.0413, 0.9613, 0.8889, 1.1311, 1.0833, 1.3488];
    ...
    htmlCode += "</tbody></table>";
    htmlCode += '<br /><br /><br /><p style="font-style: italic;">Last updated: 4/14/2025</p>';
    return htmlCode;
}
